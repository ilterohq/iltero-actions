...
- Command logging in plan evaluation — logs working directory, resolved backend/tfvars paths, and exact `terraform init`/`plan`/`iltero scan` commands before execution
