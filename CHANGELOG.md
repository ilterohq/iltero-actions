...
- Resolve unit paths to absolute before `pushd` in evaluation and deployment,
  fixing backend config and tfvars lookup when paths are relative

## [1.3.3] - 2026-04-22

### Added

- Command logging in plan evaluation — logs working directory, resolved
  backend/tfvars paths, and exact terraform commands before execution
